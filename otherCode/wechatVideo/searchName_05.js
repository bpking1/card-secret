...
const searchAccountsUrl = "http://139.9.61.95:5244/d/work/搜索账号名单.txt";  // 搜索账号名单文件
const whiteListUrl = "http://139.9.61.95:5244/d/work/白名单.txt";  // 白名单文件
const sendContentUrl = "http://139.9.61.95:5244/d/work/文案_大众类目/1-1.txt"; //读取网络上的文案，发送五十条切换下一条
...
let button = className("android.widget.Button").id("amj").findOne(2000); // 尝试在1秒内找到按钮
if (button) { // 如果找到了按钮
